      ...
      <section className="max-w-full relative w-full" data-animate="reveal" style={{ '--reveal-transform': 'scale(0.85)' }}>
        <div className="flex flex-col justify-center items-center text-center p-8">
          ...
          <div className="relative z-10 text-[#333]">
            ...
            <a href="https://docs.google.com/forms/d/1_FUmFUrmEmhXcNydf21CsXzmu2ZkJ46d3IBZtyDM-C0/edit" target="_blank" rel="noopener noreferrer"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full text-center">
            ...
            <div className="text-left text-[#333] space-y-1">
              ...
              <p><strong>Alias:</strong> milycami2026</p>
              <p><strong>CBU:</strong> 0720378588000000873204</p>
              <p><strong>Cuit</strong> 27398413569</p>
